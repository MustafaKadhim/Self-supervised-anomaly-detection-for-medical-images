...
class FactorizedMaskGIT(pl.LightningModule):
    ...
    def __init__(
        ...
        # --- CORE: transformer + token embeddings used at inference ---
        ...
        # --- AYNU: training-time hyperparameters, diagnostics, and alternative scorers ---
        self._codebook_validated = False  # one-time training/input validation flag
        self.lr = lr
        ...
        # Training-time Beta-distributed masking parameters.
        self.beta_alpha = beta_alpha
        self.beta_beta = beta_beta
        self.mask_ratio_min = mask_ratio_min
        self.mask_ratio_max = mask_ratio_max
        
        # Training-time token frequency tracking for majority-class baseline comparison.
