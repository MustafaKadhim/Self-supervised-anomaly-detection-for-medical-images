"""
Evaluate the trained Pelvic MRI anomaly detection model.

Usage
-----
    python experiments/pelvic_mri/evaluate.py --checkpoint experiments/pelvic_mri/checkpoints/checkpoint_best.pth
    python experiments/pelvic_mri/evaluate.py --checkpoint <path> --visualize
"""
...
def main(args):
    ...
    plot_roc_curve(fprs, tprs, metrics["auroc"], experiment_name="Pelvic MRI",
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Evaluate Pelvic MRI anomaly detection model")
    parser.add_argument(
        "--config",
    ...
    parser.add_argument(
        "--checkpoint",
        default="experiments/pelvic_mri/checkpoints/checkpoint_best.pth",
        help="Path to model checkpoint",
    )
    parser.add_argument("--visualize", action="store_true", help="Save anomaly map visualizations")
    parser.add_argument("--num_viz", type=int, default=20, help="Number of samples to visualize")
